...
void __global__ combined_kernel(double *h, double *u, double *v, double *dh, double *du, double *dv, double *dh1, double *du1, double *dv1, double *dh2, double *du2, double *dv2, int nx, int ny, double dx, double dy, double g, double H, double dt, unsigned int nsteps)
{
